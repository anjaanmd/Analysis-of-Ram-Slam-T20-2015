...
CREATE TABLE ram_slam_match_details(
...
CREATE TABLE ram_slam_score_details(
    ...
    constraint foreign key for_key(match_id) REFERENCES ram_slam_match_details(match_id),
...
LOAD DATA INFILE '/var/lib/mysql-files/2015_south_ram_slam_t20.batting.csv' INTO TABLE  ram_slam_batting FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;


LOAD DATA INFILE '/var/lib/mysql-files/2015_south_ram_slam_t20.bowling.csv' INTO TABLE  ram_slam_bowling FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;


LOAD DATA INFILE '/var/lib/mysql-files/2015_south_ram_slam_t20.score_details.csv' INTO TABLE  ram_slam_score_details FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;
